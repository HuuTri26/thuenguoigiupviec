							...
							<table class="table datatable">
								<thead style="background-color: #37517e; color: white">
									<tr>
										...
										<th scope="col">Tên KH <i class="bi bi-arrow-up-short"
											data-sort="customerName" data-order="asc"></i>
										</th>
										<th scope="col">SDT KH <i class="bi bi-arrow-up-short"
											data-sort="phonenumber" data-order="asc"></i>
										</th>
										<th scope="col">Địa chỉ KH <i
											class="bi bi-arrow-up-short" data-sort="address"
											data-order="asc"></i>
										</th>
								...
								<tbody id="table_contracts">
									<tr>
										...
										<td scope="col">0938297378</td>
										<td scope="col">92 Man Thiện</td>
										<td scope="col">2</td>
										<td scope="col">Man theo chổi quét nhà</td>
