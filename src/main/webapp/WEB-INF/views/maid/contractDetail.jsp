			...
			<nav>
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active"><a
						href="contractDetail.htm">Profile contract</a></li>
				</ol>
			</nav>
		</div>
		<!-- End Page Title -->
							...
							<div class="tab-content pt-2">
								...
								<div class="tab-pane fade show active profile-overview"
									...
									<div class="row">
										...
										<div class="col-lg-9 col-md-8">09389798</div>
									</div>

									<div class="row">
										<div class="col-lg-3 col-md-4 label">Địa chỉ KH</div>
									...
									<div class="row">
										...
										<div class="col-lg-9 col-md-8">Còn hiệu lực</div>
									</div>
