              ...
              <p>Add lightweight datatables to your project with using the <a href="https://github.com/fiduswriter/Simple-DataTables" target="_blank">Simple DataTables</a> library. Just add <code>.datatable</code> class name to any table you wish to conver to a datatable</p>-->
							...
							<div class="search-container" style="float: right;">
								<select id="searchSelect" class="form-select"
									...
									<option value="name">Tên loại dịch vụ</option>
...
let tableRows = Array.from(document.querySelectorAll("#table_categorys tr"));
...
function displayPage(page) {
  ...
  const tableBody = document.getElementById("table_categorys");
...
document.getElementById('searchButton').addEventListener('click', () => {
    ...
    if (filteredRows.length === 0) {
        ...
        document.getElementById('table_categorys').innerHTML = '';
        document.getElementById('table_categorys').appendChild(noResultRow);
    } else {
...
function resetTable() {
    ...
    document.getElementById('table_categorys').innerHTML = '';
    originalTableRows.forEach(row => document.getElementById('table_categorys').appendChild(row));
}
