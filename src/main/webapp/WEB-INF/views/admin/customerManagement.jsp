    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="customerManagement.html">Customer</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
<!--                     <th scope="col">Pincode</th>                   -->
                ...
                <tbody>
                  <tr>
                    ...
                    <td scope="col">huutri@gmail.com</td>
                    <td scope="col">Nam</td>
                    <td scope="col">31/02/2024</td>
                    <td scope="col">03849738</td>
                    <td scope="col">91 Man Thiện</td>
<!--                     <td scope="col">Email Id</td> -->
<!--                     <td scope="col">Address</td> -->
<!--                     <td scope="col">City</td> -->
                    <td scope="col">Đã xác thực</td>   
                    <td scope="col"><a href="customerDetail.htm"  class="btn btn-primary "><i class="bi-pencil"></i></a><a href="customerDetail.htm" class="btn btn-danger"><i class="bi-trash"></i></a></td>
                  </tr>
