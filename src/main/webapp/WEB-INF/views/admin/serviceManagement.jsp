          ...
          <div class="card">
            <div class="card-body">
              <div class="card-title">
                <a href="addService.htm" class="btn btn-primary">Thêm dịch vụ</a>
              </div>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  <tr>
                    ...
                    <td scope="col">Base Charge</td>
                      <td scope="col">Base Charge</td>
                    <td scope="col"><a href="updateService.htm"  class="btn btn-primary "><i class="bi-pencil"></i></a><a href="#" class="btn btn-danger"><i class="bi-trash"></i></a></td>
                  </tr>
                  <tr>
                    <td scope="row">2</td>
                    <td scope="col">Service Name</td>
                    <td scope="col">Base Charge</td>
                      <td scope="col">Base Charge</td>
                    <td scope="col"><a href="update_subject.html" class="btn btn-primary">Update</a><a href="#" class="btn btn-danger">delete</a></td>
                  </tr>
                  <tr>
                    <td scope="row">3</td>
                    <td scope="col">Service Name</td>
