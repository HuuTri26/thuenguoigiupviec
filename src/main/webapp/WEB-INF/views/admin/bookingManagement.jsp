    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="bookingManagement.htm">Thông tin đặt dịch vụ</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
              ...
              <table class="table datatable">
                <thead style="background-color: #37517e; color: white">
                  <tr>
                    ...
                    <th scope="col">Số lượng cần thuê</th>
                ...
                <tbody>
                  <tr>
                    ...
                    <td scope="col">Tiền mặt</td>
                    <td scope="col">Đã thanh toán</td>
                    <td scope="col">Đã xác nhận</td>
                  
                    <td scope="col"><a href="bookingDetail.html" class="btn btn-primary"><i class="bi-pencil"></i></a><a href="#" class="btn btn-danger"><i class="bi-trash"></i></a></td>
                  </tr>
                    <tr>
                    <td scope="row">1</td>
                    <td scope="col">3</td>
                    ...
                    <td scope="col"><a href="update_exam.html" class="btn btn-primary"><i class="bi-pencil"></i></a><a href="#" class="btn btn-danger"><i class="bi-trash"></i></a></td>
                  </tr>
                </tbody>
              </table>
