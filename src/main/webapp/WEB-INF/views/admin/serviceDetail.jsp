...
<body>
		...
		<div class="pagetitle">
			...
			<nav>
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active"><a href="admin/serviceDetail.htm">Service</a></li>
				</ol>
			</nav>
		</div>
		<!-- End Page Title -->
						...
						<div class="card-body pt-3">
							...
							<div class="tab-content pt-2">
								...
								<div class="tab-pane fade show active profile-overview"
							        ...
							        <div class="row">
										<div class="col-lg-3 col-md-4 label ">Loại</div>
										<div class="col-lg-9 col-md-8">Dọn nhà</div>
									</div>

									<div class="row">
										<div class="col-lg-3 col-md-4 label">Thời gian gói</div>
										<div class="col-lg-9 col-md-8">2h</div>
									</div>
									...
									<div class="row">
										<div class="col-lg-3 col-md-4 label">Số lượng giúp việc</div>
  ...
  <footer id="footer" class="footer">
	...
	<a href="admin/serviceDetail.htm#main"
