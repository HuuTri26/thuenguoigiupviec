		...
		<div class="container d-flex justify-content-between">
			...
			<nav id="navbar" class="navbar">
				<ul>
					...
					<li class="dropdown"><a href="#"><span>Đắng nhập</span> <i
							class="bi bi-chevron-down"></i></a>
						<ul>
							<li><a href="admin/adminLogin.htm">Admin</a></li>
							<li><a href="maid/maidLogin.htm">Người giúp việc</a></li>
							<li><a href="customer/customerLogin.htm">Khách hàng</a></li>
	...
	<main id="main">
		...
		<section id="about" class="about">
			<div class="container" data-aos="fade-up">
				...
				<p>Website cung cấp dịch vụ thuê giúp việc tại nhà</p>
					...
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide">
							<div class="testimonial-item">
								<p>
									...
									ahahahhaha<i class="bx bxs-quote-alt-right quote-icon-right"></i>
								</p>
								<img
						...
						<div class="swiper-slide">
							<div class="testimonial-item">
								<p>
									<i class="bx bxs-quote-alt-left quote-icon-left"></i>
									hahahahaha<i class="bx bxs-quote-alt-right quote-icon-right"></i>
								</p>
								<img
						...
						<div class="swiper-slide">
							<div class="testimonial-item">
								<p>
									<i class="bx bxs-quote-alt-left quote-icon-left"></i> hhhhhhh <i
						...
						<div class="swiper-slide">
							<div class="testimonial-item">
								<p>
									<i class="bx bxs-quote-alt-left quote-icon-left"></i>Không hài
									lòng <i class="bx bxs-quote-alt-right quote-icon-right"></i>
								</p>
								<img
				...
				<div class="faq-list">
					<ul>
						<li data-aos="fade-up" data-aos-delay="100"><i
							...
							data-bs-target="#faq-list-1">Tôi có thể đặt tối đa bao nhiêu
								dịch vụ <i class="bx bx-chevron-down icon-show"></i><i
					...
					<div class="col-lg-10">
						<form action="forms/contact.php" method="post" role="form"
							...
							<div class="my-3">
								...
								<div class="sent-message">Đã gửi. Cam on!</div>
							</div>
				...
				<div class="row">
					...
					<div class="col-lg-3 col-md-6">
						<div class="footer-info">
							...
							<p>
							<p>
								97 Man Thiện<br> Hiệp Phú <br> <strong>Phone:</strong>
								12345678910JQK<br> <strong>Email:</strong>
								Email:noreply@gmail.com<br>
							</p>
					...
					<div class="col-lg-2 col-md-6 footer-links">
						<h4>Link</h4>
						<ul>
							<li><i class="bx bx-chevron-right"></i> <a href="#">Trang
									chủ</a></li>
							<li><i class="bx bx-chevron-right"></i> <a href="#">About
									us</a></li>
							<li><i class="bx bx-chevron-right"></i> <a href="#">Dịch
									vụ</a></li>
							<li><i class="bx bx-chevron-right"></i> <a href="#">Người
									giúp việc</a></li>
							<li><i class="bx bx-chevron-right"></i> <a href="#">Chính
									sách</a></li>
						</ul>
					</div>
					...
					<div class="col-lg-3 col-md-6 footer-links">
						<h4>Design by</h4>
						<ul>
							<li><i class="bx bx-chevron-right"></i> <a href="#">Nhóm
									16</a></li>
